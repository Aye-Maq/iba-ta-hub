...
const firstNames = ['Areeba', 'Hamza', 'Zoya', 'Bilal', 'Maham', 'Usman', 'Sana', 'Hassan', 'Ayesha', 'Daniyal', 'Mariam', 'Saad'];
const lastNames = ['Khan', 'Ahmed', 'Raza', 'Malik', 'Hussain', 'Ali', 'Qureshi', 'Siddiqui', 'Iqbal', 'Sheikh', 'Farooq', 'Nawaz'];

export const previewStudents: PreviewStudent[] = Array.from({ length: 136 }, (_, index) => {
  ...
  return { classNo: `BBA-${(index % 4) + 1}`, erp, name, statuses, namingPenalty: index % 37 === 0 ? 1 : 0 };
});

export const initialGroups: PreviewGroup[] = [
  { id: 'Group 1', members: ['Areeba Khan', 'Hamza Ahmed'], capacity: 5 },
  { id: 'Group 2', members: ['Maham Raza', 'Bilal Malik', 'Zoya Hussain'], capacity: 5 },
  { id: 'Group 3', members: [], capacity: 5 },
  { id: 'Group 4', members: ['Usman Ali'], capacity: 5 },
];

export const initialClaims: PreviewClaim[] = [
  { id: 'claim-1', assignment: 'Case brief 01', claimedOn: '18 Aug 2026', days: 1 },
];
